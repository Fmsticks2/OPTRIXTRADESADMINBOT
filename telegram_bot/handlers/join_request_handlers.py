...
async def handle_chat_join_request(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    1. Send a welcome message with a deep link to the user
    2. Approve their join request
    ...
    # Auto-approve the join request if enabled
    ...
    try:
        ...
        if admin_user_id:
            admin_notification = (
                ...
                f"Chat: {chat_id}\n"
                f"Auto-approved: {BotConfig.ENABLE_AUTO_APPROVE_JOIN_REQUESTS}"
            )
